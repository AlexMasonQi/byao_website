...
public class Music implements Serializable
{
    ...
    {
        return "Music{" + "id=" + id + ", musicPath='" + musicPath + '\'' + ", musicName='" + musicName + '\'' + ", musicSinger='" + musicSinger + '\'' + ", musicTime='" + musicTime + '\'' + ", musicLrc='" + musicLrc + '\'' + ", musicImagesPath='" + musicImagesPath + '\'' + ", musicImagesCount='" + musicImagesCount + '\'' + '}';
    }
}
